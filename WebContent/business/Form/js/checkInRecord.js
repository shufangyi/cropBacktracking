 $(document).ready(function() 
{
	 ...
	 function init(){
       ...
       // alert("hello");
		 ...
		 ({
			//发送数据请求
	    	url: 'business/getCheckInRecords.do',
			method: 'post',
           ...
           //【设置列属性】
			columns: [
			 ...
			 {field: 'id',title: 'id'}, 	
			 {field: 'picksegBtcode',title: '采摘溯源码'},	 
			 {field: 'checkintime',title: '质检时间'}, 
			 {field: 'checkinsegBtcode',title: '质检溯源码'},
			 {field: 'stocklocation',title: '存储地点',editable: true},
			 {field: 'checker',title: '质检员',editable: true},
	  ...
	  $('#delete').click(function(){
		 ...
		 else
		 {
			 ...
			 $.ajax({
				  type: "post",
				  url: "business/delCheckInRecordInfo.do",
	  ...
	  function update(row)
	  {
		  ...
		  $.ajax({
			  type: "post",
			  url: "business/updateCheckInRecordInfo.do",
			  //data:{data:JSON.stringify(rows)},
			  data:	row,
			  success: function (data, status) {
				  if (status == "success") {
