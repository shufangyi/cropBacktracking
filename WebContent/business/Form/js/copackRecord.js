 $(document).ready(function() 
{
	 ...
	 function init(){
       ...
       // alert("hello");
		 ...
		 ({
			//发送数据请求
	    	url: 'business/getCopackRecords.do',
			method: 'post',
           ...
           //【设置列属性】
			columns: [
			 ...
			 {field: 'id',title: 'id'}, 	
			 {field: 'checkinsegBtcode',title: '质检溯源码'},	 
			 {field: 'copacktime',title: '包装时间'}, 
			 {field: 'ordernum',title: '订单号'},
			 {field: 'copacklocation',title: '包装地点',editable: true},
			 {field: 'productBtcode',title: '产品溯源码',editable: true},
			 {field: 'copacker',title: '包装员',editable: true},
			 {field: 'producedate',title: '生产日期'},
			 {field: 'producelocation',title: '生产地'},
			 {field: 'specifications',title: '规格'},
			 {field: 'netContent',title: '净含量'},
			 {field: 'storagecondition',title: '贮藏条件'},
	  ...
	  $('#delete').click(function(){
		 ...
		 else
		 {
			 ...
			 $.ajax({
				  type: "post",
				  url: "business/delCopackRecordInfo.do",
	  ...
	  function update(row)
	  {
		  ...
		  $.ajax({
			  type: "post",
			  url: "business/updateCopackRecordInfo.do",
			  //data:{data:JSON.stringify(rows)},
			  data:	row,
			  success: function (data, status) {
				  if (status == "success") {
