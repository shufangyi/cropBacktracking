...
{ 
	 ...
	 function init(){
			 ...
			 ({
	           ...
	           //【设置列属性】
				columns: [
				 ...
				 {field: 'picktime',title: '采摘时间'}, 
				 {field: 'picktype',title: '采摘方式'},
				 {field:'picksegBtcode',title:'采摘溯源码'},
				 {field: 'picknum',title: '采摘数量',editable: true},
				 {field: 'comment',title: '备注',editable: true},
				 {field: 'grower',title: '种植员',editable: true},
		  ...
		  $('#delete').click(function(){
			 ...
			 else
			 {
				 ...
				 $.ajax({
					  type: "post",
					  url: "business/delPickRecordInfo.do",
	 ...
	 $('#search').click(function(){
	  ...
	  function update(row)
	  {
		  ...
		  $.ajax({
			  type: "post",
			  url: "business/updatePickRecordInfo.do",
			  //data:{data:JSON.stringify(rows)},
			  data:	row,
			  success: function (data, status) {
				  if (status == "success") {
