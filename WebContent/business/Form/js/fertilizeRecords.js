 $(document).ready(function() 
{
       ...
       // alert("hello");
		 ...
		 ({
			//发送数据请求
	    	url: 'business/getFertilizerRecords.do',
			method: 'post',
           ...
           //【设置列属性】
			columns: [
			 ...
			 {field: 'fertilizername',title: '肥料名称'}, 
			 {field: 'fertilizertime',title: '施肥时间'},
			 {field: 'fertilizernum',title: '施肥数量',editable: true},
			 {field: 'fertilizerfrequency',title: '施肥次数',editable: true},
	  ...
	  $('#delete').click(function(){
		 ...
		 else
		 {
			 ...
			 $.ajax({
				  type: "post",
				  url: "business/delFertilizerRecordInfo.do",
	  ...
	  function update(row)
	  {
		  ...
		  $.ajax({
			  type: "post",
			  url: "business/updatefertilizerRecordInfo.do",
			  //data:{data:JSON.stringify(rows)},
			  data:	row,
			  success: function (data, status) {
				  if (status == "success") {
