...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="system/css/topframe1.css">
</head>
<body>
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <span class="navbar-brand-name">后台管理</span>
            </div>

            <ul class="nav navbar-nav navbar-right">
                <li class="btn-group" role="group" aria-label="...">
                    <button type="button" id="login-name" class="btn btn-info">${admin.adminNum }&nbsp;<span class="glyphicon glyphicon-user"></span></button>
